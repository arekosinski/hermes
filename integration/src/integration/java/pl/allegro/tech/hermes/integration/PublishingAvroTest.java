...
public class PublishingAvroTest extends IntegrationTest {
    ...
    public void initialize() throws Exception {
        schema = new Schema.Parser().parse(this.getClass().getResourceAsStream("/user.avsc"));
    ...
    public void shouldPublishAvroAndConsumeJsonMessage() throws InterruptedException, ExecutionException, TimeoutException, IOException {
        ...
        remoteService.expectMessages("{\"name\":\"Bob\",\"age\":{\"int\":50},\"favoriteColor\":blue}");
        ...
        //TODO implement avro support in consumers
        //remoteService.waitUntilReceived();
    }

    @Test
    public void shouldThrowExceptionForAvroTopicWithoutSchema() {
        //TODO
    }

    @Test
    public void shouldThrowExceptionForPublishedMessageInvalidWithSchema() {
        //TODO
    }

    @Test
    public void shouldThrowExceptionForTopicCreationWithInvalidAvroSchema() {
        //TODO
    }
